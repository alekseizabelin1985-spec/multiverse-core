...
| Поле | Значение |
|---|---|
| Исходный путь | `shared/tinyml` |
| Причина | локальные ONNX-модели вне стека MVP-1 (вместе с `fake_deps` — заглушками onnxruntime) |
...
| Эпик возврата | нет |
| Что использовало | `services/entity-actor` |
