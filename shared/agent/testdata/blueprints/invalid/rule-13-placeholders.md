---
name: player-test-placeholders
version: "1.0"
description: A personal GM without a system prompt and with placeholders outside the dictionary (rule 13)
level: task
role: personal-gm
...
## phase2
Настроение игрока {Player.name}: {player.mood}. События: {events}
