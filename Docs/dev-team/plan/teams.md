...
| 1.9 – 1.10 | developer#1 (EPIC-002 I2 старт: atomic группы), developer#2 (EPIC-005 ops: `mvctl report`) | developer#1, #2, #3 (I1b: миграция `legacy`, e2e, golden) | developer#2 (бот: flow/deliver/privacy), developer#1 (EPIC-004 I2 старт: groups) | — | 6 |
