...
### T-436: Kafka-адаптер: Close прерывает чтение и коммит, но не контекст обработчика · Размер: S · Статус: todo · Волна 1 (бэклог)
...
### T-437: `--alias` в `llm-server.{sh,ps1}`, пин `LLAMACPP_BUILD`, сокращение `ops/models.txt` · Размер: S · Статус: todo · Волна 1 (бэклог)
...
### T-439: EPIC-003 — потолок длины нарратива под целевую конфигурацию · Размер: S · Статус: todo · Волна 1 · Исполнитель: architect#2 (EPIC-003)
