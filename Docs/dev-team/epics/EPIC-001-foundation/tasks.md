...
### T-413: Пограничные случаи правил 3 и 8 линтера композиции · Размер: M · Статус: todo · Волна 1 (после приёмки T-255)
...
### T-415: Обходные и беззвучные пути: recover в StartAll, ошибка публикации у заглушки встречи, хук go-fmt вне модуля · Размер: S · Статус: todo · Волна 1 (бэклог)
...
### T-426: Перехват паники обработчика в eventbus.Delivery (C-01 v1.5) · Размер: S · Статус: todo · Волна 1 (после T-418)
