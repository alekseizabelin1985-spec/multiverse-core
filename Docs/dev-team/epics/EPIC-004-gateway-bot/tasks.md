...
Версия 0.1.2 · 2026-09-13 · tech-lead#3 (TEAM-3) · редакционная правка под дерево `develop` 1c2ee7e, `contracts.md` v0.10 и gitflow; объём и состав задач не менялись (история версий — §9). Прежняя редакция: 0.1.1 · 2026-09-09 · этап A4 «Планирование», шаг 3 · к объединённому G3.
