...
Зависит: T-223, **T-417** (EPIC-001: `Dedup.Has`/`Add`, `WithCauseID` — C-01 v1.4; T-416). Ссылки: US-037, FR-121…123, КД §5.2–5.3, design §3.2 R2, **C-01 v1.4, C-14 v1.2, ADR-027**.
